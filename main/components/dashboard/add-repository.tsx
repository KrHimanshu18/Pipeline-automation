...
export function AddRepository({ onRepositoryAdded }: AddRepositoryProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
      console.log("Repository added:", { repoName, repoUrl });
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div className="h-10 w-10 rounded-lg bg-github-dark flex items-center justify-center group-hover:bg-zinc-700 transition-colors">
